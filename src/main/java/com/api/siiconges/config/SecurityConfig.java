package com.api.siiconges.config;

import com.api.siiconges.service.security.UserDetailsServiceImpl;
import com.api.siiconges.utils.security.AuthenticationTokenFilter;
...
public class SecurityConfig {
    ...
    public OpenAPI openAPI() {
        return new OpenAPI().addSecurityItem(new SecurityRequirement().addList("Bearer Authentication"))
            ...
            .info(new Info().title("SII-CONGES API")
